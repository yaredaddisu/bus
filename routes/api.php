...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('/buses/{bus}/seats', [BusSeatController::class, 'getSeatsByBus']);
    Route::resource('/reservations', ReservationController::class);
    Route::resource('/assign-seat', SeatController::class);
    Route::get('/routes/{bus}/route', [RoutesController::class, 'getRoutesById']);
    Route::get('/seats', [BusSeatController::class, 'getSeatsByDate']);
     Route::get('/seats-route', [BusSeatController::class, 'fetchSeatsByRouteAndDate']);
     Route::get('/passengers', [BusSeatController::class, 'index']);

    Route::resource('/city', CityController::class);
    Route::resource('/routes', RoutesController::class);
    Route::post('/route/delete-all-route',[RoutesController::class,'deleteAllRoute']);

    Route::post('/bus/delete-all-bus',[BusController::class,'deleteAllBus']);
    Route::post('/city/delete-all-city',[CityController::class,'deleteAllCity']);
