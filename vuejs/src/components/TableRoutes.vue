...
const loading = computed(() => store.state.routes.loading);

store.dispatch("getRoutes", { search: search.value });
        ...
        <thead>
          <tr>
            ...
            <th
              ...
              :sort-field="sortField"
              :sort-direction="sortDirection"
              @click="sortroutes('destination_city')"
            >
              destination_city
            </th>
            <th
            ...
            <th
              ...
              :sort-field="sortField"
              :sort-direction="sortDirection"
              @click="sortroutes('departure_time')"
            >
              departure_time
            </th>
            <th
          ...
          <tr v-for="route in itemsPaginated" :key="route.id">
            ...
            <td data-label="Status">
              <span
                ...
                >{{ route.status == 1 ? "Active" : "In Active" }}
              </span>
            </td>
