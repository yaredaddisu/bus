...
const routes = computed(() => store.state.reservations.data);
const loading = computed(() => store.state.reservations.loading);

store.dispatch("getReservations", { search: search.value });
